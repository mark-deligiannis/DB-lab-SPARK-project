...
joined_df = crime_df.join(revgecoding, ["LAT","LON"], "inner") \
                    .drop("LAT","LON")
...
max_final_df = joined_df.join(max_income_2015, ["ZIPcode"]) \
...
min_final_df = joined_df.join(min_income_2015, ["ZIPcode"]) \
                        .drop("ZIPcode","Zip code")
